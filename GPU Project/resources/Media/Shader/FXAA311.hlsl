...
float4 FXAAEffectPS( float4 screenPos : SV_Position ) : SV_Target
{
    ...
    return FxaaPixelShader( screenPos.xy * g_FXAA.rcpFrame.xy, float4( 0, 0, 0, 0 ), tex,tex,tex, g_FXAA.rcpFrame, g_FXAA.rcpFrameOpt,g_FXAA.rcpFrameOpt2,g_FXAA.rcpFrameOpt2,
